...
\begin{frame}{États du jeu}
	\begin{itemize}
		...
		\item Une situation/état $s$ est un 4-uplet $(p, j_1, j_2, c, d, m)$ où $d$ est un booléen indiquant si le joueur a doublé ou pas, et $m \in \{1,2\}$ indiquant quelle main est en train d'être joué dans l'éventualité d'un split. Les états sont relié par les actions de $A$.
...
\begin{frame}{Encodage du problème}
